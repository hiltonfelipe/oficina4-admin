...
trait HasAssets
{
     ...
     * @var string
     */
    public static $manifest = 'vendor/oficina4-admin/minify-manifest.json';
     ...
     */
    public static $min = [
        'js'  => 'vendor/oficina4-admin/oficina4-admin.min.js',
        'css' => 'vendor/oficina4-admin/oficina4-admin.min.css',
    ];
    ...
    public static $baseCss = [
        'vendor/oficina4-admin/AdminLTE/bootstrap/css/bootstrap.min.css',
        'vendor/oficina4-admin/font-awesome/css/font-awesome.min.css',
        'vendor/oficina4-admin/oficina4-admin/oficina4-admin.css',
        'vendor/oficina4-admin/nprogress/nprogress.css',
        'vendor/oficina4-admin/sweetalert2/dist/sweetalert2.css',
        'vendor/oficina4-admin/nestable/nestable.css',
        'vendor/oficina4-admin/toastr/build/toastr.min.css',
        'vendor/oficina4-admin/bootstrap3-editable/css/bootstrap-editable.css',
        'vendor/oficina4-admin/google-fonts/fonts.css',
        'vendor/oficina4-admin/AdminLTE/dist/css/AdminLTE.min.css',
    ];
    ...
    public static $baseJs = [
        'vendor/oficina4-admin/AdminLTE/bootstrap/js/bootstrap.min.js',
        'vendor/oficina4-admin/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js',
        'vendor/oficina4-admin/AdminLTE/dist/js/app.min.js',
        'vendor/oficina4-admin/jquery-pjax/jquery.pjax.js',
        'vendor/oficina4-admin/nprogress/nprogress.js',
        'vendor/oficina4-admin/nestable/jquery.nestable.js',
        'vendor/oficina4-admin/toastr/build/toastr.min.js',
        'vendor/oficina4-admin/bootstrap3-editable/js/bootstrap-editable.min.js',
        'vendor/oficina4-admin/sweetalert2/dist/sweetalert2.min.js',
        'vendor/oficina4-admin/oficina4-admin/oficina4-admin.js',
    ];

    /**
     * @var string
     */
    public static $jQuery = 'vendor/oficina4-admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js';
    ...
    public static function baseCss($css = null, $minify = true)
    {
        ...
        array_unshift(static::$baseCss, "vendor/oficina4-admin/AdminLTE/dist/css/skins/{$skin}.min.css");
