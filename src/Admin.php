...
class Admin
{
    ...
    /**
     * Returns the long version of Oficina4-admin.
     *
     * @return string The long application version
     */
    public static function getLongVersion()
    {
        return sprintf('Oficina4-admin <comment>version</comment> <info>%s</info>', self::VERSION);
    }
    ...
    /**
     * Register the oficina4-admin builtin routes.
     *
     * @return void
     *
