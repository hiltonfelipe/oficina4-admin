...
class SwitchField extends Field
{
    protected static $css = [
        '/vendor/oficina4-admin/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css',
    ];

    protected static $js = [
        '/vendor/oficina4-admin/bootstrap-switch/dist/js/bootstrap-switch.min.js',
    ];
