...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/oficina4-admin/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/oficina4-admin/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
