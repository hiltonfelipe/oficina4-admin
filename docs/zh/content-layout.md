...
`oficina4-admin`的布局可参考后台首页的布局文件[HomeController.php](https://github.com/z-song/oficina4-admin/blob/master/src/Console/stubs/HomeController.stub)的`index()`方法。
...
`oficina4-admin`的布局使用bootstrap的栅格系统，每行的长度是12，下面是几个简单的示例：
