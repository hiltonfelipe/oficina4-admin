...
The layout usage of `oficina4-admin` can be found in the `index()` method of the home page's layout file [HomeController.php](https://github.com/z-song/oficina4-admin/blob/master/src/Console/stubs/HomeController.stub).
...
`oficina4-admin` use grid system of bootstrap,The length of each line is 12, the following is a few simple examples:
