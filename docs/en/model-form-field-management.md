...
Locate the file `app/Admin/bootstrap.php`. If the file does not exist, update `oficina4-admin` and create this file.
...
>Static resources in the class can also be imported from outside, see [Editor.php](https://github.com/z-song/oficina4-admin/blob/1.3/src/Form/Field/Editor.php)
...
Finally, find the file `app/Admin/bootstrap.php`, if the file does not exist, update `oficina4-admin`, and then create this file, add the following code:
